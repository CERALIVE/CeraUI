...
import {
	...
	decommissionMutationProcedure,
	getAllModemsProcedure,
	getFccUnlockProcedure,
	getModemBandsProcedure,
	getModemCapabilitiesProcedure,
	getModemGpsProcedure,
	getModemSmsProcedure,
	getModemUssdProcedure,
	getUsbModeOptionsProcedure,
	listMutationBlocksProcedure,
	rebaselineMutationProcedure,
	scanModemProcedure,
	setFccUnlockProcedure,
	setFiveGPreferenceProcedure,
	setModemBandsProcedure,
	setModemCapabilitiesProcedure,
	setModemGpsProcedure,
	setUsbModeProcedure,
	unlockSimPin2Procedure,
	unlockSimProcedure,
	unlockSimPukProcedure,
	ussdCancelProcedure,
	ussdInitiateProcedure,
...
} from "./procedures/modems-router.procedure.ts";
import {
...
const stableRoutes = {
	...
	modems: base.router({
		...
		unlockSimPin2: unlockSimPin2Procedure,
		unlockSimPuk: unlockSimPukProcedure,
		setUsbMode: setUsbModeProcedure,
		getUsbModeOptions: getUsbModeOptionsProcedure,
		getFccUnlock: getFccUnlockProcedure,
		setFccUnlock: setFccUnlockProcedure,
		...
		getSms: getModemSmsProcedure,
		getGps: getModemGpsProcedure,
		setGps: setModemGpsProcedure,
		getUssd: getModemUssdProcedure,
		ussdInitiate: ussdInitiateProcedure,
		ussdRespond: ussdRespondProcedure,
		ussdCancel: ussdCancelProcedure,
		listMutationBlocks: listMutationBlocksProcedure,
		acknowledgeMutation: acknowledgeMutationProcedure,
		decommissionMutation: decommissionMutationProcedure,
		rebaselineMutation: rebaselineMutationProcedure,
	}),
