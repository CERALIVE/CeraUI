import { INTERNAL_TRANSITION_WORST_CASE_BOUND_MS } from "@ceralive/cerastream";
import {
...
export const ENGINE_TRANSITION_STOP_DEADLINE_MS =
	INTERNAL_TRANSITION_WORST_CASE_BOUND_MS + STOP_DEADLINE_MS;
