...
const CERASTREAM_FIELDS: SchemaManifest = {
	...
	activeEncodeSchema: [
		...
		"capture.state",
		"capture.live_inputs",
		"capture.degraded_inputs",
		"capture.standby_since_ms",
		"capture.suspension.kind",
		"capture.transition.kind",
		"capture.active_source.input_id",
		"capture.active_source.width",
		"capture.active_source.height",
		"capture.active_source.framerate",
		"capture.active_source.retimed",
		"capture.active_source.rescaled",
		"capture.retime.in",
		"capture.retime.out",
		"capture.retime.drop",
		"capture.retime.duplicate",
		"capture.failover_rate_policy",
		"frames_emitted",
		"pipeline_playing",
	],
