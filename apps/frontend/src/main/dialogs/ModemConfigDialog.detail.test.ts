...
// first mount pays a one-time cost the later cases reuse — locally ~203 ms against ~50 ms
// siblings, but 5326 ms on a CPU-contended runner with no persisted transform cache, which
