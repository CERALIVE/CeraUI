...
const ko = {
	...
	settings: {
		...
		index: {
			...
			devicePasswordDesc: "로컬 네트워크에서 이 기기에 접근하는 데 사용하는 비밀번호를 설정합니다",
	...
	dialogs: {
		...
		blockedUpdating: "업데이트가 진행 중입니다. 재시작하기 전에 기다려 주세요.",
	},
pairing: {
			title: "기기 페어링",
			...
			instructions: "페어링을 완료하려면 클라우드 대시보드에 이 코드를 입력하세요.",
	...
	network: {
		...
		modem: {
			...
			noNetworksFound: "아직 발견된 네트워크가 없습니다. 스캔하여 사업자를 검색하세요.",
			scanForNetworks: "네트워크 스캔",
			credentials: "자격 증명",
			configureDescription: "셀룰러 연결 설정을 구성합니다",
			simUnlock: {
				title: "SIM PIN 필요",
				description: "이 SIM 카드가 잠겨 있습니다. PIN을 입력하여 모뎀을 잠금 해제하세요.",
				pinLabel: "SIM PIN",
