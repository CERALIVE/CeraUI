...
const ko = {
	...
	settings: {
		...
		audioDeviceExternal: "외장",
		audioDeviceExternalHint:
			"기기에 내장된 것이 아니라 연결해서 쓰는 액세서리입니다.",
	...
	live: {
		goLive: {
			readyTitle: "라이브 시작 준비 완료",
			readyHint: "모든 점검을 통과했습니다.",
			showChecks: "설정 표시",
			hideChecks: "설정 숨기기",
			autoSelected: "자동 선택됨: {name}",
			change: "변경",
			validated: "확인됨",
			notChecked: "확인되지 않음",
			maxBitrate: "최대 비트레이트",
		...
		startFailed: {
			...
			source_taken_over:
				"선택한 카메라가 쓰던 연결을 다른 기기가 사용하고 있습니다. 해당 카메라를 다시 연결하거나 원하는 카메라를 선택한 후 다시 시도하세요.",
		},
		startFailure: {
			class: {
		...
		preview: {
			...
			unavailable: {
				...
				noVideo: {
					title: "아직 미리보기 영상이 없습니다",
					body: "엔진이 미리보기를 수락했지만 영상을 보내지 않습니다. 미리보기는 스트림이 실행 중일 때 인코딩된 신호를 표시합니다.",
				},
				tokenRejected: {
					title: "미리보기 권한 없음",
					body: "미리보기 액세스 토큰이 거부되었습니다. 미리보기를 중지했다가 다시 시작해 재시도하세요.",
				},
				mintFailed: {
					title: "미리보기를 시작할 수 없음",
					body: "미리보기를 인증할 수 없습니다. 연결을 확인한 후 다시 시도하세요.",
				},
				interrupted: {
					title: "미리보기 중단됨",
					body: "미리보기 스트림이 끊겼고 다시 연결할 수 없습니다. 다시 시작하여 재시도하세요.",
				},
				backpressure: {
					title: "미리보기가 따라가지 못함",
					body: "이 장치 또는 연결이 미리보기 스트림을 따라가지 못합니다. 더 빠른 연결에서 다시 시도하세요.",
				},
				noSourceApplied: {
					title: "선택된 소스 없음",
					body: "스트림이 유휴 상태일 때 미리볼 캡처 소스를 선택하세요.",
				},
				sourceUnavailable: {
					title: "소스를 사용할 수 없음",
					body: "선택한 소스를 더 이상 사용할 수 없습니다. 다른 소스를 선택한 후 다시 시도하세요.",
				},
				deviceBusy: {
					title: "장치 사용 중",
					body: "캡처 장치가 다른 곳에서 사용 중입니다. 해제한 후 미리보기를 다시 시작하세요.",
				},
				pipelineFailed: {
					title: "미리보기 시작 실패",
		...
		source: {
			...
			noSignal: "신호 없음",
			noSignalTitle: "이 입력에 신호가 없습니다",
			noSignalBody:
				"이 입력은 인식되어 정상이지만 지금은 아무것도 들어오지 않습니다. 케이블 반대편 기기가 영상을 보내지 않는 상태입니다. 전원이 켜져 있는지, 케이블이 양쪽에 제대로 꽂혀 있는지 확인하세요. 이 소스는 그대로 선택해 두어도 됩니다. 신호가 들어오면 바로 동작합니다.",
			audioAmbiguousTitle: "이 카메라에 오디오 장치가 여러 개 있습니다",
			audioAmbiguousBody:
				"이 카메라가 자체 오디오 장치를 두 개 이상 보고했습니다. 어느 것을 원하는지 추측하지 않습니다. 아래에서 알맞은 장치를 선택하세요.",
