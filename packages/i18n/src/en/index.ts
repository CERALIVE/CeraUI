...
const en = {
	...
	live: {
		...
		preview: {
			...
			tierBadgeAria: "Preview delivery tier",
			tierWebrtc: "WebRTC",
		...
		source: {
			...
			audioNoCaptureTitle: "This input carries no audio",
			audioNoCaptureBody:
				"This port's audio card is present but cannot be recorded from, so there is nothing to capture. Streaming continues without audio — pick an audio source below to add one.",
			...
			coarseUnboundTitle: "This source has no device connected",
			coarseUnboundBody:
				"You've selected a capability that nothing is plugged into right now, so the stream can't start from it. Pick a connected source instead.",
