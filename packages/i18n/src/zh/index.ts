...
const zh = {
	...
	settings: {
		...
		deviceHealth: {
			title: "设备健康",
			description: "最近 5 分钟的温度、负载与编码器状态",
			lane: {
				temp: "SoC 温度",
				load: "平均负载 · 1 分钟 · 全部进程",
			},
			...
			encoder: {
				...
				engineUnavailable: "推流引擎无法访问",
				framesAdvancing: "帧正在推进",
				framesStalled: "帧未推进",
				framesUnknown: "此时间段内无帧遥测",
			},
			cores: {
				title: "编码器核心",
				busy: "忙碌",
			...
			power: {
				title: "供电轨",
				notInstrumented: "此主板不会向 CeraUI 报告电压或电流。",
				noReading: "无读数",
			},
		},
		networkIngest: {
		...
		index: {
			...
			deviceHealth: "设备健康",
			deviceHealthDesc: "随时间变化的温度、负载与编码器状态",
			versions: "设备版本",
		...
		audioDeviceExternal: "外接",
		audioDeviceExternalHint: "可插拔的外接配件，并非设备内置。",
	...
	live: {
		...
		startFailed: {
			...
			source_taken_over:
				"另一台设备正在占用所选摄像头原先的连接。请重新连接该摄像头或选择你想用的摄像头后重试。",
		},
		startFailure: {
			class: {
		...
		source: {
			...
			audioNoCaptureTitle: "此输入不传输音频",
			audioNoCaptureBody:
				"该端口的声卡存在，但无法从中录音，因此没有可采集的内容。推流将在无音频的情况下继续——请在下方选择音频源以添加声音。",
