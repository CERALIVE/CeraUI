...
const es = {
	...
	live: {
		...
		preview: {
			...
			tierBadgeAria: "Nivel de entrega de la vista previa",
			tierWebrtc: "WebRTC",
		...
		source: {
			...
			noSignal: "Sin señal",
			noSignalTitle: "Sin señal en esta entrada",
			noSignalBody:
				"Esta entrada está presente y funciona, pero ahora mismo no llega nada por ella: el dispositivo del otro extremo del cable no está enviando imagen. Comprueba que esté encendido y que el cable esté bien conectado por ambos extremos. Puedes seleccionar esta fuente igualmente: empezará a funcionar en cuanto haya señal.",
			audioAmbiguousTitle: "Varios dispositivos de audio en esta cámara",
			audioAmbiguousBody:
				"Esta cámara informa de más de un dispositivo de audio propio, así que no vamos a adivinar cuál quieres. Elige el correcto abajo.",
			...
			mjpegLearnMore: "Cómo comprobamos UVC H.264",
			coarseUnboundTitle: "Esta fuente no tiene ningún dispositivo conectado",
			coarseUnboundBody:
				"Has seleccionado una capacidad a la que ahora mismo no hay nada conectado, así que la transmisión no puede iniciarse desde ella. Elige una fuente conectada.",
			coarseSuggestionOne: "¿Querías decir {name}?",
		...
		encoder: {
			...
			deviceModeUnsupported:
				"La cámara conectada no puede grabar con estos ajustes. Elige una resolución y una velocidad de fotogramas compatibles y vuelve a guardar.",
	...
	notifications: {
		...
		encoderModeClamped:
			"La cámara conectada no admitía tus ajustes de codificador guardados, así que se ajustaron a {resolution} a {framerate} fps.",
		streamHealthNoVideo:
	...
	settings: {
		...
		audioDeviceExternal: "Externo",
		audioDeviceExternalHint:
			"Un accesorio conectable, no integrado en este dispositivo.",
		...
		notAvailableAudioSourceHint:
			"Esta entrada de audio ya no se detecta. Vuelve a conectarla o elige otra fuente.",
