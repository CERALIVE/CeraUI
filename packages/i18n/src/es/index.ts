...
const es = {
	...
	live: {
		...
		configureToStart: "Configura un servidor de retransmisión para comenzar a transmitir",
	...
	settings: {
		...
		index: {
			...
			devicePasswordDesc: "Establece la contraseña usada para acceder a este dispositivo en la red local",
			...
			logsDesc: "Descarga registros del dispositivo y del sistema para diagnóstico",
	...
	dialogs: {
		...
		dhcpHint: "Déjalo en blanco para usar DHCP (direccionamiento automático).",
		...
		rebootConfirm: "El dispositivo se desconectará durante unos 30 segundos mientras se reinicia.",
		powerOffConfirm:
...
pairing: {
			...
			description: "Vincula este dispositivo a tu cuenta en la nube con un código de reclamación.",
			...
			instructions: "Introduce este código en tu panel de la nube para completar el emparejamiento.",
			...
			pairFailed: "Error de emparejamiento. Verifica el código e inténtalo de nuevo.",
	...
	network: {
		...
		modem: {
			...
			apnRequired: "El APN es obligatorio cuando el APN automático está desactivado",
			availableNetworks: "Redes disponibles",
			noNetworksFound: "Aún no se encontraron redes. Busca para encontrar operadores.",
			...
			simUnlock: {
				...
				description: "Esta tarjeta SIM está bloqueada. Introduce su PIN para desbloquear el módem.",
