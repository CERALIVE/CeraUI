...
const hi = {
	...
	live: {
		...
		networkIngest: {
			...
			subtitle: "उसी नेटवर्क पर किसी अन्य एन्कोडर या फ़ोन से इस डिवाइस पर प्रकाशित करें।",
			...
			instructions: "अपने फ़ोन या एन्कोडर को इस पते पर सेट करें, फिर प्रकाशित करना शुरू करें।",
