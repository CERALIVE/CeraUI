...
const hi = {
	...
	live: {
		...
		startFailed: {
			...
			srt_connect_failed: "SRT सर्वर तक नहीं पहुँच सके। गंतव्य और अपना कनेक्शन जाँचें, फिर पुनः प्रयास करें।",
			srt_connection_lost: "स्ट्रीम शुरू होने से पहले SRT कनेक्शन टूट गया। दोबारा प्रयास करने से मदद मिल सकती है।",
			srtla_initial_connect_failed: "SRTLA सर्वर से कनेक्ट नहीं हो सके। गंतव्य और अपना कनेक्शन जाँचें।",
			srtla_no_connections: "कोई बॉन्डेड कनेक्शन उपलब्ध नहीं है। जाँचें कि आपके नेटवर्क लिंक सक्रिय हैं।",
			capture_audio_error: "कैप्चर डिवाइस ने ऑडियो त्रुटि बताई। इसे पुनः कनेक्ट करें और दोबारा प्रयास करें।",
			capture_video_error: "कैप्चर डिवाइस ने वीडियो त्रुटि बताई। इसे पुनः कनेक्ट करें और दोबारा प्रयास करें।",
			pipeline_stall: "शुरू होते समय इनपुट स्रोत रुक गया। स्रोत जाँचें और दोबारा प्रयास करें।",
		},
