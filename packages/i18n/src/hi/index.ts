...
const hi = {
	...
	live: {
		...
		source: {
			...
			mjpegBody:
				"यह कैप्चर डिवाइस USB पर हार्डवेयर H.264/H.265 एन्कोडिंग प्रदान नहीं करता, इसलिए एन्कोडर इसके Motion-JPEG (MJPEG) वीडियो को कैप्चर करता है और आपके चुने हुए कोडेक में फिर से एन्कोड करता है। यह हार्डवेयर का सटीक विवरण है, कोई खराबी नहीं।",
		},
		summary: {
