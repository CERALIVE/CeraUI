...
const ja = {
	...
	settings: {
		...
		dialogs: {
			...
			sources: {
				title: "ソース",
				description:
					"ライブピッカーに表示する映像ソースを選び、このネットワーク上のスマートフォンやエンコーダーからデバイスへ配信できるようにします。",
				testPatternToggle: "テストパターンを表示",
				testPatternHint:
					"ソース選択にビルトインのテストパターンを予備信号として残します。実際のソースを接続したら、オフにして非表示にします。",
			},
	...
	live: {
		...
		startFailed: {
			...
			source_taken_over:
				"選択したカメラが使っていた接続を、別の機器が使用しています。そのカメラを接続し直すか、使いたいカメラを選んでから、もう一度お試しください。",
		},
		startFailure: {
			class: {
		...
		preview: {
			...
			unavailable: {
				...
				noVideo: {
					title: "プレビュー映像はまだありません",
					body: "エンジンはプレビューを受け付けましたが、映像を送信していません。プレビューはストリーム実行中にエンコード済みの映像を表示します。",
				},
				tokenRejected: {
					title: "プレビューが許可されていません",
					body: "プレビューのアクセストークンが拒否されました。プレビューを停止してから開始し直して再試行してください。",
				},
				mintFailed: {
					title: "プレビューを開始できません",
					body: "プレビューを認証できませんでした。接続を確認して再試行してください。",
				},
				interrupted: {
					title: "プレビューが中断されました",
					body: "プレビューのストリームが切断され、再確立できませんでした。開始し直して再試行してください。",
				},
				backpressure: {
					title: "プレビューが追いつきません",
					body: "このデバイスまたは接続はプレビューのストリームに追いつけません。より高速な接続で再試行してください。",
				},
				noSourceApplied: {
					title: "ソースが選択されていません",
					body: "ストリームがアイドル中にプレビューするキャプチャソースを選択してください。",
				},
				sourceUnavailable: {
					title: "ソースを利用できません",
					body: "選択したソースは利用できなくなりました。別のソースを選択して再試行してください。",
				},
				deviceBusy: {
					title: "デバイスが使用中",
					body: "キャプチャデバイスは別の場所で使用されています。解放してからプレビューを開始し直してください。",
				},
				pipelineFailed: {
		...
		source: {
			...
			noSignal: "信号なし",
			noSignalTitle: "この入力に信号がありません",
			noSignalBody:
				"この入力は認識されていて正常ですが、今は何も届いていません。ケーブルの反対側の機器が映像を送っていない状態です。電源が入っているか、ケーブルが両端でしっかり挿さっているか確認してください。このソースは選択したままで構いません。信号が来た時点で動作します。",
			audioAmbiguousTitle: "このカメラに複数のオーディオデバイス",
			audioAmbiguousBody:
				"このカメラは自身のオーディオデバイスを複数報告しています。どれを使うかは推測しません。下から正しいものを選んでください。",
			audioNoSameDeviceTitle: "このカメラに固有のオーディオはありません",
			audioNoSameDeviceBody:
				"このカメラ自身のハードウェアはオーディオを扱いません。別のデバイスのマイクを流用することは決してありません。下からオーディオソースを選んでください。",
			audioNoCaptureTitle: "この入力はオーディオを伝送しません",
			audioNoCaptureBody:
				"このポートのオーディオカードは存在しますが録音できないため、取り込めるものがありません。配信はオーディオなしで続きます。音声を追加するには下からオーディオソースを選んでください。",
