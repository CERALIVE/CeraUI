...
const ar = {
	updatingOverlay: {
		...
		successDescription: 'يتم إعادة تشغيل الجهاز، وستتمكن من استخدامه بأحدث الميزات في غضون دقائق',
		of: 'من',
		steps: 'خطوات',
	},
	devtools: {
		...
		toastTesterDescription: 'اختبار أنواع مختلفة من إشعارات toast مع خيارات قابلة للتخصيص',
		...
		connectionFailedDesc: 'تعذر الاتصال بالخادم. يرجى التحقق من اتصالك بالإنترنت.',
		...
		demoInfo4: 'Will auto-stop after completion (remove this component in production)',
		...
		testDifferentTypes: 'Test different types of toast notifications and their behaviors',
		...
		screenshotUtilityDescription: 'التقاط بسيط لجميع علامات التبويب والمظاهر والوضع غير المتصل',
	...
	general: {
		...
		streamingMessage: 'يستخدم بثك {usingNetworksCount} شبكات مع تأخير {srtLatency} مللي ثانية',
	...
	settings: {
		...
		djiCameraMessage: 'قد تعمل كاميرات DJI بشكل أفضل باستخدام وضع الإدخال USB-LIBUVCH264',
		...
		audioSettingsMessage: 'ستظهر إعدادات الصوت بمجرد تحديد خيار صالح في قسم الترميز',
		optional: 'اختياري',
		placeholders: {
		...
		errors: {
			...
			bitrateInvalid: 'يجب أن يكون معدل البت بين 2000 و 12000 كيلوبت في الثانية',
	...
	network: {
		...
		pageDescription: 'إدارة اتصالات WiFi والنقاط الساخنة ومودمات الخلوية وواجهات الشبكة',
		sections: {
		...
		summary: {
			...
			networkInfo: 'معلومات الشبكة',
			networksActive: '{count} شبكة، {active} نشطة • الإجمالي: {total} كيلوبت/ثانية',
	...
	networkHelper: {
		toast: {
			...
			scanningWifiDescription: 'البحث عن شبكات WiFi جديدة، قد يستغرق هذا بضع ثوانٍ',
	...
	advanced: {
		...
		lanPasswordTooltip: 'قم بتعيين كلمة مرور لحماية الوصول إلى واجهة belaUI على الويب.',
		...
		logManagementDescription: 'تنزيل سجلات النظام لاستكشاف الأخطاء وإصلاحها والتصحيح',
	...
	pwa: {
		...
		installAndroidMenuDescription: 'استخدم قائمة المتصفح لـ "إضافة إلى الشاشة الرئيسية"',
	...
	offline: {
		title: 'أنت غير متصل',
		description: 'يحتاج CeraUI إلى اتصال بالإنترنت لإدارة جهاز BELABOX الخاص بك.',
