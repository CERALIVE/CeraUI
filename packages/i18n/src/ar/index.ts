...
const ar = {
	...
	settings: {
		...
		deviceStats: {
			...
			cpuLoadLight: "منخفض",
			cpuLoadModerate: "متوسط",
			cpuLoadHeavy: "مرتفع",
			cpuLoadRaw: "الحِمل {load}",
			cpuLoadHint:
				"نسبة من إجمالي طاقة المعالج — متوسط الحِمل خلال دقيقة واحدة موزّعًا على {cores} نواة.",
			cpuLoadHintNoCores:
				"متوسط الحِمل خلال دقيقة واحدة. لم يُبلِّغ هذا الجهاز عن عدد أنويته، لذا لا يمكن عرضه كنسبة من الطاقة.",
			memory: "الذاكرة",
			memoryHint:
				"نسبة الذاكرة المستخدمة. تُقاس مقابل MemAvailable حتى لا تُحتسب ذاكرة التخزين المؤقت القابلة للاسترجاع كمستخدمة.",
			swap: "التبديل",
			swapNone: "لا يوجد",
			cpuFreq: "تردد المعالج",
			cpuFreqHint:
				"التردد الحالي مقابل الحد الأقصى للعتاد، لكل سياسة cpufreq. اسم السياسة هو مجلد في sysfs وليس مجموعة أنوية.",
			ddr: "ناقل DDR",
			ddrHint: "حِمل متحكم الذاكرة، يُقرأ من جهاز devfreq في اللوحة.",
			gpu: "المعالج الرسومي",
			gpuHint: "حِمل المعالج الرسومي، يُقرأ من واجهة Mali أو devfreq في اللوحة.",
		},
		deviceHealth: {
			title: "صحة الجهاز",
			description: "الحرارة والحِمل وحالة المُرمِّز خلال آخر 5 دقائق",
			lane: {
				temp: "حرارة المعالج",
			...
			axis: { now: "الآن", minutesAgo: "−{n} دقيقة" },
			waiting: "في انتظار أول قراءة",
			gap: "لا توجد قراءات في هذه الفترة",
			unavailable: "غير متاح",
			delta: "Δ {value} خلال 5 دقائق",
			peak: "الذروة {value}",
			...
			encoder: {
				...
				engineUnavailable: "تعذّر الوصول إلى محرك البث",
				framesAdvancing: "الإطارات تتقدّم",
				framesStalled: "الإطارات لا تتقدّم",
				framesUnknown: "لا توجد قياسات إطارات في هذه الفترة",
			},
			cores: {
				title: "أنوية المُرمِّز",
				busy: "مشغول",
				idle: "خامل",
				percentNote: "دورة تشغيل مقاسة، تُقرأ لكل نواة ترميز.",
				binaryNote:
			...
			power: {
				title: "خطوط الطاقة",
				notInstrumented: "لا تُبلِّغ هذه اللوحة CeraUI بالجهد أو التيار.",
		...
		index: {
			...
			wifiCountry: "بلد الواي فاي",
			wifiCountryDesc:
				"يحدد النطاق التنظيمي الذي يقرر قنوات نقطة الاتصال المسموح بها",
			deviceHealth: "صحة الجهاز",
			deviceHealthDesc: "الحرارة والحِمل وحالة المُرمِّز عبر الزمن",
		...
		dialogs: {
			...
			wifiCountry: {
				title: "بلد الواي فاي",
				description:
					"يحدد بلدك قنوات الواي فاي التي يمكن لهذا الجهاز البث عليها. تتم إعادة قراءة قائمة القنوات من الراديو بعد تطبيق البلد.",
				label: "البلد",
				placeholder: "اختر بلدًا",
				search: "البحث عن البلدان",
				world: "عالمي (الأكثر تقييدًا)",
				apply: "تطبيق",
				applying: "جارٍ التطبيق…",
				applied: "تم تحديث النطاق التنظيمي.",
				failed: "تعذر تطبيق النطاق التنظيمي.",
				unavailable: "تغيير النطاق التنظيمي غير متاح في وضع المحاكاة.",
				effectiveLabel: "الراديو يُبلغ",
				restartNotice:
					"تُعاد تشغيل نقطة الاتصال النشطة لاعتماد النطاق الجديد. تعيد الأجهزة المتصلة الاتصال تلقائيًا.",
				mismatchWarning:
					"لا يزال الراديو يُبلغ عن نطاق مختلف، لذلك لم تتغير قائمة القنوات.",
			},
			sources: {
				title: "المصادر",
				description:
	...
	hud: {
		...
		bitrateTarget: "الهدف",
		bitrateMeasuredHint:
			"مُقاس عبر روابطك المجمّعة — ما غادر الجهاز فعليًا، بما في ذلك حِمل البروتوكول.",
		bitrateTargetHint:
			"المعدل الذي يستهدفه المُرمِّز. إنه إعداد يضبطه المحرك، وليس قياسًا لما يُرسَل فعليًا.",
	...
	live: {
		...
		startFailed: {
			...
			source_taken_over:
				"يشغل جهاز آخر الآن الاتصال الذي كانت تستخدمه الكاميرا المحددة. أعد توصيل تلك الكاميرا أو اختر الكاميرا التي تريدها، ثم حاول مرة أخرى.",
		},
		startFailure: {
			class: {
		...
		preview: {
			...
			resume: "استئناف المعاينة",
			compatBadge: "وضع التوافق",
			tierBadgeAria: "مستوى تسليم المعاينة",
			tierWebrtc: "WebRTC",
			...
			unavailable: {
				...
				tokenRejected: {
					title: "المعاينة غير مصرَّح بها",
					body: "تم رفض رمز الوصول إلى المعاينة. أوقف المعاينة ثم ابدأها لإعادة المحاولة.",
				},
				mintFailed: {
					title: "تعذّر بدء المعاينة",
					body: "تعذّر التصريح بالمعاينة. تحقق من الاتصال وأعد المحاولة.",
				},
				interrupted: {
					title: "تمت مقاطعة المعاينة",
					body: "انقطع بث المعاينة وتعذّر إعادة إنشائه. ابدأه من جديد لإعادة المحاولة.",
				},
				backpressure: {
					title: "المعاينة لا تواكب",
					body: "لا يستطيع هذا الجهاز أو هذا الاتصال مواكبة بث المعاينة. أعد المحاولة عبر اتصال أسرع.",
				},
				noSourceApplied: {
					title: "لم يتم تحديد مصدر",
					body: "اختر مصدر التقاط لمعاينته أثناء توقّف البث.",
				},
				sourceUnavailable: {
					title: "المصدر غير متاح",
					body: "لم يعد المصدر المحدد متاحاً. اختر مصدراً آخر وأعد المحاولة.",
				},
				deviceBusy: {
					title: "الجهاز مشغول",
					body: "جهاز الالتقاط قيد الاستخدام في مكان آخر. حرّره ثم ابدأ المعاينة من جديد.",
				},
				pipelineFailed: {
					title: "فشل بدء المعاينة",
					body: "تعذّر على المحرك بدء مسار المعاينة. ابدأه من جديد لإعادة المحاولة.",
				},
				passthroughActive: {
					title: "المعاينة غير متاحة أثناء التمرير المباشر",
					body: "يذهب بث الكاميرا مباشرة إلى المخرج، لذا لا يوجد ما يمكن معاينته هنا.",
				},
				pausedHidden: {
					title: "المعاينة متوقفة مؤقتاً",
					body: "توقفت المعاينة بعد عدم مشاهدتها لتوفير الموارد. استأنفها لعرضها مجدداً.",
				},
			},
			encode: {
				label: "ترميز المعاينة بالعتاد",
				description: "رمّز بث المعاينة باستخدام مرمّز العتاد في اللوحة.",
				helper: "يُطبَّق على البث التالي.",
				activeLabel: "مرمّز المعاينة النشط",
				activeNone: "لا يجري ترميز معاينة حالياً",
				activeHardware: "{element} \u2014 عتاد",
				activeSoftware: "{element} \u2014 برمجي",
				fallbackTitle: "تراجعت معاينة العتاد إلى البرمجيات",
				fallbackFactoryMissing:
					"مرمّز المعاينة العتادي غير مثبّت في هذه النسخة، لذا تُرمَّز المعاينة برمجياً.",
				fallbackPropertyFailure:
					"رفض مرمّز المعاينة العتادي أحد الإعدادات، لذا تُرمَّز المعاينة برمجياً.",
				fallbackPropertyLabel: "الإعداد المرفوض",
			},
		},
		inputPicker: {
			title: "مصادر الإدخال",
		...
		source: {
			...
			noSignal: "لا توجد إشارة",
			noSignalTitle: "لا توجد إشارة على هذا المدخل",
			noSignalBody:
				"هذا المدخل موجود ويعمل، لكن لا يصل إليه أي شيء الآن — الجهاز في الطرف الآخر من الكابل لا يرسل صورة. تأكد من تشغيله ومن إحكام توصيل الكابل من الطرفين. لا يزال بإمكانك اختيار هذا المصدر: سيعمل بمجرد ظهور إشارة.",
			audioAmbiguousTitle: "عدة أجهزة صوت على هذه الكاميرا",
			audioAmbiguousBody:
				"تُبلّغ هذه الكاميرا عن أكثر من جهاز صوت خاص بها، لذلك لن نخمّن أيها تريد. اختر الجهاز الصحيح أدناه.",
			audioNoSameDeviceTitle: "لا يوجد صوت خاص بهذه الكاميرا",
			audioNoSameDeviceBody:
				"لا شيء في عتاد هذه الكاميرا ينقل الصوت، ونحن لا نستعير ميكروفونًا من جهاز آخر أبدًا. اختر مصدر صوت أدناه.",
			audioNoCaptureTitle: "هذا المدخل لا ينقل صوتًا",
			audioNoCaptureBody:
				"بطاقة الصوت لهذا المنفذ موجودة لكن لا يمكن التسجيل منها، لذا لا يوجد ما يُلتقط. يستمر البث بدون صوت — اختر مصدر صوت أدناه لإضافة الصوت.",
			...
			modeLabel: "تنسيق الالتقاط",
			modeHint:
				"يمكن لهذه الكاميرا إرسال أكثر من تنسيق فيديو واحد، ولكل تنسيق دقّاته ومعدّلات الإطارات الخاصة به. اختر التنسيق الذي تريد الالتقاط به — وستتحدّث إعدادات المُرمِّز لتطابقه.",
			modeLadderHint:
				"الدقّات ومعدّلات الإطارات أدناه هي التي يوفّرها تنسيق الالتقاط هذا.",
			modeApplyNote: "تغيير التنسيق يعيد تشغيل الالتقاط عند بدء البث.",
			modeSwitchFailed: "تعذّر تغيير تنسيق الالتقاط",
			degradedBadge: "متدهور",
			degradedTitle: "هذا المصدر يواجه مشكلة",
			degradedBody:
				"الجهاز لا يزال متصلاً، لكن المُرمِّز أبلغ عن مشكلة في القراءة منه. تحقّق من الكابل ومن الجهاز نفسه — وإذا استمرّ الأمر، جرّب تنسيقاً آخر أو مصدراً آخر.",
			degradedReason: "المُبلَّغ عنه: {reason}",
			emptyTitle: "لم يتم اكتشاف أي مدخلات",
			emptyBody:
				"وصّل كاميرا أو مصدر HDMI بهذا الجهاز وسيظهر هنا تلقائياً. لا حاجة إلى إعداد أي شيء مسبقاً.",
			lostBannerRemembered:
				"لا يزال مدرجاً لأنه الجهاز الذي استخدمه بثّك الأخير.",
		},
		summary: {
		...
		passthrough: {
			activeChip: "تمرير مباشر",
			activeHint:
				"يذهب بث الكاميرا مباشرة إلى المخرج — لا يعيد الجهاز الترميز، لذا فإن معدل البت التكيّفي المجمّع غير نشط.",
		},
		modes: {
			label: "الوضع",
			streaming: "البث",
		...
		encoder: {
			...
			applyChoice: {
				title: "التطبيق الآن أم عند البدء التالي؟",
				description:
					"تتطلب تغييرات الدقة ومعدل الإطارات والمصدر إعادة تشغيل البث. إعادة التشغيل قصيرة، لكن المشاهدين سيلاحظونها.",
				now: "التطبيق الآن (يعيد تشغيل البث لفترة وجيزة)",
				nextStart: "التطبيق عند البدء التالي",
			},
			applyPhase: {
				applying: "جارٍ التطبيق \u2014 إعادة تشغيل البث\u2026",
				applied: "الإعدادات الجديدة قيد التشغيل",
				reverted: "تعذّر التطبيق \u2014 لا تزال إعداداتك السابقة قيد التشغيل",
				rollbackFailed: "تعذّر التطبيق، وتوقف البث",
				reasonTeardownTimeout: "لم يتم تحرير الكاميرا في الوقت المناسب.",
				reasonDeadlineExceeded: "استغرق التغيير وقتًا أطول من المتوقع.",
				reasonEngineLost: "توقف محرك البث في الجهاز عن الاستجابة.",
				reasonRejected: "تعذّر على الجهاز استخدام هذه الإعدادات.",
				reasonUnknown:
					"راجع الإعدادات \u2190 سجلات النظام للحصول على التفاصيل.",
			},
			accelerated: "عتاد",
			software: "برمجي",
			...
			passthrough: {
				...
				disclosurePassthrough:
					"تمرير مباشر — تتحكم الكاميرا في معدل البت؛ معدل البت التكيّفي المجمّع غير نشط.",
				disclosureTranscode:
					"إعادة ترميز {input}→{output} — معدل البت التكيّفي نشط.",
				disclosureForceUnavailable:
					"لا يمكن إجبار التمرير المباشر — لا يستطيع هذا المصدر إخراج ترميز المخرج، لذا لن يبدأ البث. استخدم تلقائي أو إيقاف.",
				bitrateFixed: "معدل البت مضبوط بواسطة الكاميرا — التمرير المباشر نشط.",
				inputRaw: "غير مضغوط",
			},
		},
	},
