...
const ar = {
	...
	devtools: {
		...
		demoInfo4:
			"سيتوقف تلقائياً بعد الاكتمال (أزل هذا المكون في الإنتاج)",
		...
		testDifferentTypes:
			"اختبر أنواعاً مختلفة من إشعارات Toast وسلوكياتها",
	...
	settings: {
		...
		index: {
			...
			devicePasswordDesc: "عيّن كلمة المرور المستخدمة للوصول إلى هذا الجهاز على الشبكة المحلية",
	...
	dialogs: {
		...
		rebootConfirm: "سينقطع اتصال الجهاز لمدة 30 ثانية تقريباً أثناء إعادة التشغيل.",
		powerOffConfirm:
