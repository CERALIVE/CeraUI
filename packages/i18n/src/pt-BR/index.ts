...
const ptBR = {
	...
	settings: {
		...
		index: {
			...
			devicePasswordDesc: "Defina a senha usada para acessar este dispositivo na rede local",
			cloudRemote: "Servidor remoto na nuvem",
			cloudRemoteDesc: "Conecte-se a um relé na nuvem para gerenciamento remoto",
			ssh: "Acesso SSH",
	...
	dialogs: {
		...
		rebootConfirm: "O dispositivo será desconectado por cerca de 30 segundos enquanto reinicia.",
		powerOffConfirm:
...
pairing: {
			...
			description: "Vincule este dispositivo à sua conta na nuvem com um código de reivindicação.",
			...
			instructions: "Insira este código no seu painel da nuvem para concluir o emparelhamento.",
			...
			pairFailed: "Falha no emparelhamento. Verifique o código e tente novamente.",
	...
	network: {
		...
		modem: {
			...
			apnRequired: "O APN é obrigatório quando o APN automático está desativado",
			availableNetworks: "Redes disponíveis",
			noNetworksFound: "Nenhuma rede encontrada ainda. Procure para encontrar operadoras.",
			...
			simUnlock: {
				...
				description: "Este cartão SIM está bloqueado. Digite o PIN para desbloquear o modem.",
				pinLabel: "PIN do SIM",
	...
	live: {
		...
		configureToStart: "Configure um servidor de retransmissão para começar a transmitir",
