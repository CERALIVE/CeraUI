...
const de = {
	...
	hud: {
		...
		bitrateTarget: "Ziel",
		bitrateMeasuredHint:
			"Über deine gebündelten Verbindungen gemessen — was das Gerät tatsächlich verlassen hat, inklusive Protokoll-Overhead.",
		bitrateTargetHint:
			"Die Rate, die der Encoder anstrebt. Eine Vorgabe, die die Engine anpasst — keine Messung des tatsächlich Gesendeten.",
	...
	live: {
		goLive: {
			readyTitle: "Bereit für den Live-Start",
			readyHint: "Alle Prüfungen bestanden.",
			showChecks: "Einrichtung anzeigen",
			hideChecks: "Einrichtung ausblenden",
			autoSelected: "Automatisch ausgewählt: {name}",
			change: "Ändern",
			validated: "Bestätigt",
			...
			fix: {
				openSource: "Quelle auswählen",
				goNetwork: "Netzwerk einrichten",
				openServer: "Ziel auswählen",
			},
		},
		server: {
		...
		ingest: {
			...
			sessionEnded: "Sitzung beendet \u00b7 {duration}",
			duration: "Dauer",
			contribution: "Anteil",
			samples: "Messungen",
			peak: "Spitze",
		...
		preview: {
			...
			tierBadgeAria: "Wiedergabe-Ebene der Vorschau",
			tierWebrtc: "WebRTC",
		...
		source: {
			...
			audioAmbiguousTitle: "Mehrere Audiogeräte an dieser Kamera",
			audioAmbiguousBody:
				"Diese Kamera meldet mehr als ein eigenes Audiogerät, deshalb raten wir nicht, welches du möchtest. Wähle unten das richtige aus.",
			audioNoSameDeviceTitle: "Diese Kamera hat kein eigenes Audio",
			audioNoSameDeviceBody:
				"Auf der Hardware dieser Kamera überträgt nichts Audio, und wir leihen uns nie ein Mikrofon von einem anderen Gerät. Wähle unten eine Audioquelle aus.",
			audioNoCaptureTitle: "Dieser Eingang überträgt kein Audio",
			audioNoCaptureBody:
				"Die Audiokarte dieses Anschlusses ist vorhanden, kann aber nicht aufgenommen werden, es gibt also nichts aufzuzeichnen. Das Streaming läuft ohne Audio weiter — wähle unten eine Audioquelle, um Ton hinzuzufügen.",
			...
			mjpegLearnMore: "So prüfen wir auf UVC H.264",
			coarseUnboundTitle: "Für diese Quelle ist kein Gerät angeschlossen",
			coarseUnboundBody:
				"Du hast eine Funktion gewählt, an der gerade nichts angeschlossen ist – der Stream kann darüber nicht starten. Wähle stattdessen eine verbundene Quelle.",
		...
		encoder: {
			...
			deviceModeUnsupported:
				"Die angeschlossene Kamera kann mit diesen Einstellungen nicht aufnehmen. Wähle eine unterstützte Auflösung und Bildrate und speichere erneut.",
	...
	notifications: {
		...
		encoderModeClamped:
			"Deine gespeicherten Encoder-Einstellungen wurden von der angeschlossenen Kamera nicht unterstützt und auf {resolution} mit {framerate} fps angepasst.",
		streamHealthNoVideo:
	...
	settings: {
		...
		audioDeviceExternal: "Extern",
		audioDeviceExternalHint:
			"Ein ansteckbares Zubehör, nicht fest im Gerät verbaut.",
		noAudioSourceSelected: "Keine Audioquelle ausgewählt",
		notAvailableAudioSource: "Nicht verfügbar",
		notAvailableAudioSourceHint:
			"Dieser Audioeingang wird nicht mehr erkannt. Schließe ihn wieder an oder wähle eine andere Quelle.",
