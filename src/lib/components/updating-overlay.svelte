  ...
  <Drawer.Root open={true} closeOnOutsideClick={false} closeOnEscape={false}>
    <Drawer.Content
      ...
      <div class="relative flex h-full w-full flex-col items-center justify-center p-4 sm:p-8">
        ...
        <div class="mx-auto mb-4 max-w-2xl space-y-2 text-center sm:mb-8 sm:space-y-4" class:nav-entrance={isVisible}>
          ...
          <div
            ...
            <div class="flex items-center gap-1 sm:gap-2">
              {#if animationPhase === 'downloading'}
                ...
                <span class="text-primary text-sm font-medium sm:text-base">{$_('updatingOverlay.downloading')}</span>
              {:else if animationPhase === 'unpacking'}
                <Package class="h-4 w-4 animate-pulse text-amber-500 sm:h-5 sm:w-5" />
                <span class="text-sm font-medium text-amber-500 sm:text-base">{$_('updatingOverlay.unpacking')}</span>
              {:else if animationPhase === 'installing'}
                <Cog class="h-4 w-4 animate-spin text-blue-500 sm:h-5 sm:w-5" />
                <span class="text-sm font-medium text-blue-500 sm:text-base">{$_('updatingOverlay.installing')}</span>
          ...
          <div class="flex flex-col items-center justify-center">
            <div class="relative mb-4 sm:mb-6">
              ...
              <div class="absolute inset-0 flex items-center justify-center">
                <span class="text-foreground bg-background/80 rounded-full px-3 py-1.5 text-xl font-bold sm:text-2xl">
        ...
        <div class="mx-auto mt-4 flex max-w-md items-center justify-center gap-2 sm:mt-8 sm:gap-6">
          ...
          <div
            ...
            <span class="text-center text-[10px] font-medium sm:text-xs" class:text-primary={details?.downloading > 0}>
          ...
          <div
            ...
            <span class="text-center text-[10px] font-medium sm:text-xs" class:text-amber-500={details?.unpacking > 0}>
          ...
          <div
            ...
            <span class="text-center text-[10px] font-medium sm:text-xs" class:text-blue-500={details?.setting_up > 0}>
