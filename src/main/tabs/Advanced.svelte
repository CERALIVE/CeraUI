    ...
    <div class="grid gap-6 lg:grid-cols-2 lg:items-start">
      ...
      <Card.Root class="bg-card/50 border-0 shadow-lg backdrop-blur-sm">
        ...
        <Card.Content class="space-y-6">
          ...
          <div class="space-y-3">
            <div class="space-y-2">
              <Label for="lanPassword" class="text-sm font-medium">
          ...
          <div class="space-y-3">
            <div class="space-y-2">
              <Label for="remoteKey" class="text-sm font-medium">
          ...
          <div class="space-y-4">
            <div class="flex items-center gap-3 border-b border-blue-200/50 pb-2 dark:border-blue-800/50">
              ...
              <div>
                <h3 class="text-sm font-semibold text-blue-900 dark:text-blue-100">{$_('advanced.systemActions')}</h3>
                <p class="text-xs text-blue-600/70 dark:text-blue-300/70">{$_('advanced.systemActionsDescription')}</p>
              </div>
            </div>
              ...
              <div
                ...
                <div class="flex flex-1 items-start justify-between">
                  <div class="flex items-center gap-3">
                    ...
                    <div>
                      <h4 class="font-semibold text-yellow-900 dark:text-yellow-100">{$_('advanced.reboot')}</h4>
              ...
              <div
                ...
                <div class="flex flex-1 items-start justify-between">
                  <div class="flex items-center gap-3">
                    ...
                    <div>
                      <h4 class="font-semibold text-red-900 dark:text-red-100">{$_('advanced.powerOff')}</h4>
                      <p class="text-xs text-red-600/70 dark:text-red-300/70">{$_('advanced.powerOffDescription')}</p>
                    </div>
                  </div>
                </div>
                <div class="mt-4">
      ...
      <Card.Root class="bg-card/50 border-0 shadow-lg backdrop-blur-sm">
        ...
        <Card.Content class="space-y-6">
          ...
          <div class="space-y-3">
            <div class="space-y-2">
              <Label for="sshPassword" class="text-sm font-medium">
                  ...
                  <div class="flex items-center gap-2">
                    <div
                      class={cn(
                        ...
                        sshStatus ? 'bg-green-500 shadow-green-500/30' : 'bg-gray-400 shadow-gray-400/30',
                      )}>
                    </div>
                    <span class="font-semibold text-purple-900 dark:text-purple-100">{$_('advanced.sshServer')}:</span>
                  </div>
                  <span
                    class={cn(
            ...
            <Button
              ...
              <div class="flex items-center gap-3">
                <div class={cn('h-3 w-3 rounded-full shadow-sm', 'bg-white/90 shadow-white/30')}></div>
          ...
          <div class="space-y-4 border-t border-purple-200/30 pt-6 dark:border-purple-800/30">
            <div class="flex items-center gap-3 border-b border-purple-200/50 pb-2 dark:border-purple-800/50">
          ...
          <div class="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
            ...
            <div class="grid grid-cols-2 gap-6 text-sm lg:grid-cols-4">
              <div
                ...
                <p class="font-mono font-semibold text-gray-900 dark:text-gray-100">{revisions.belaUI}</p>
              </div>
              <div
                class="rounded-lg border border-gray-200/50 bg-white/60 p-3 dark:border-gray-700/50 dark:bg-gray-800/60">
                <p class="mb-1 text-xs font-medium text-gray-600 dark:text-gray-400">Belacoder</p>
                <p class="font-mono font-semibold text-gray-900 dark:text-gray-100">{revisions.belacoder}</p>
              </div>
              <div
                class="rounded-lg border border-gray-200/50 bg-white/60 p-3 dark:border-gray-700/50 dark:bg-gray-800/60">
                <p class="mb-1 text-xs font-medium text-gray-600 dark:text-gray-400">SRTLA</p>
                <p class="font-mono font-semibold text-gray-900 dark:text-gray-100">{revisions.srtla}</p>
              </div>
              <div
                class="rounded-lg border border-gray-200/50 bg-white/60 p-3 dark:border-gray-700/50 dark:bg-gray-800/60">
