  ...
  {#if $isNavigationTransitioning}
    <div
      ...
      <div class="flex flex-col items-center space-y-4">
        ...
        <div class="relative">
          <div class="border-muted-foreground/20 border-t-primary h-8 w-8 animate-spin rounded-full border-4"></div>
          <!-- Subtle glow effect -->
          <div
        ...
        <div class="text-muted-foreground flex items-center space-x-1 text-sm">
          ...
          <div class="flex space-x-1">
            ...
            <div class="bg-primary h-1 w-1 animate-pulse rounded-full [animation-delay:150ms]"></div>
            <div class="bg-primary h-1 w-1 animate-pulse rounded-full [animation-delay:300ms]"></div>
          </div>
        </div>
      </div>
    </div>
  ...
  {#if $navigationError}
    <div class="flex min-h-[200px] items-center justify-center" in:fade={{ duration: 300 }}>
      <div class="max-w-md space-y-4 text-center">
        <div class="bg-destructive/10 mx-auto flex h-16 w-16 items-center justify-center rounded-full">
