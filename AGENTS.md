...
device discovery. Both consumers pin published cerastream 2026.9.9, schema 0.19.0.
...
`@ceralive/cerastream@2026.9.9` binding carries `get-capabilities.encoders[]` with
